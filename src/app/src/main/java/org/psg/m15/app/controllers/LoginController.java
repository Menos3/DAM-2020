    ...
    private boolean login(String tfUsuariText, String tfPasswordText) throws IllegalBlockSizeException, InvalidKeyException, BadPaddingException, NoSuchAlgorithmException, NoSuchPaddingException {
        ...
        if(tfUsuariText.isEmpty()) {
            ...
            if(tfPasswordText.isEmpty ()) {
                ...
                String contrasenyaEncriptada = eh.AESEncrypt(tfPasswordText);
                ...
                switch (states) {
                    ...
                    case GRANTED:
                        ...
                        break;
                    case FAILED:
                        Utilitats.AlertaGeneralWarning(Constants.TITOL_ALERTA_LOGIN, Constants.CAPCALERA_ALERTA_DADES_INCORRECTES, "Usuari i/o contrasenya no valids, recordi que te "+(3 - u.getIntents())+" intents per a entrar al sistema, despres d'aixo el seu usuari sera bloquejat.");
                        break;
                    case LOCKED:
                        ...
                        GMailHelper.send(u.getEmail(), Constants.ASSUMPTE_CORREU_BLOQUEIG, Constants.COS_CORREU_BLOQUEIG);
                        break;
